...
<button onclick="document.getElementById('register_modal').showModal()" style="margin-left: 190px; margin-top: 470px;" class="btn wave-effect absolute inset-0   w-40 h-15 m-auto bg-green-700 text-white rounded-2xl hover:bg-green-800">Login Now</button>
        ...
        <dialog id="register_modal" class="modal">
            <div class="modal-box w-11/12 max-w-xl bg-green-400">
                <div class="main w-96 p-6 flex items-center flex-col bg-white m-auto my-5 border border-green-800 rounded-lg">
                    ...
                    <label class="input input-bordered flex items-center gap-2 p-2 mt-2 w-full text-sm border-green-800">Birthdate
                        <input type="date" name="birthdate" class="grow" placeholder="Birthdate" required />
                    </label>
                    <label class="input input-bordered flex items-center gap-2 p-2 mt-2 w-full text-sm border-green-800">
                        <input type="number" id="age" name="age" class="grow" placeholder="Age" required/>
                    </label>
    ...
    <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden ">
        ...
        <tbody class="text-gray-700">
            ...
            <tr>
                ...
                <div id="question" class="max-w-5xl mx-auto">
