...
<img style="width: 200px;" class=" ml-5 justify-center" src="../images/logo.png">
    ...
    <h3 class="text-center font-bold text-lg text-green-800 pt-5">Deceased Form</h3><br>
    <form action="insert.php" method="POST">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label class="block">
                <span class="text-gray-700">Last Name</span>
                <input type="text" name="lastname" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="Last Name" required>
            </label>
            <label class="block">
                <span class="text-gray-700">First Name</span>
                <input type="text" name="firstname" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="First Name" required>
            </label>
            <label class="block">
                <span class="text-gray-700">Middle Name</span>
                <input type="text" name="middlename" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="Middle Name" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Date of Birth</span>
                <input type="date" name="birthdate" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Date of Death</span>
                <input type="date" name="deathdate" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Place of Birth</span>
                <input type="text" name="birthplace" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="Place of Birth" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Place of Death</span>
                <input type="text" name="deathplace" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="Place of Death" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Cause of Death</span>
                <input type="text" name="cause_of_death" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" placeholder="Cause of Death" required>
            </label>
            <label class="block col-span-2">
                <span class="text-gray-700">Burial Date</span>
                <input type="date" name="burial_date" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" required>
            </label>

            <label class="block col-span-2">
                <span class="text-gray-700">Lot Type:</span>
                <input type="text" name="lot_type_1" value="<?php echo $_GET['lot_type'] ?>" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800"  required>
            </label>

            <label class="block col-span-2">
                <span class="text-gray-700">Area Size (Sq m):</span>
                <input type="text" id="area_size_1" value="<?php echo $_GET['lot_area'] ?>" name="area_size_1" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800  " required>
            </label>
...
<!--             
            ...
            <label class="block col-span-2">
                ...
                <input type="text" id="down_payment_1" value="<?php echo $_GET['down'] ?>" name="down_payment_1" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" required>
            </label>

            <label class="block col-span-2">
                <span class="text-gray-700">Monthly Amortization 0% Interest:</span>
            <select id="monthly_amortization_1" name="monthly_amortization_1" class="mt-1 block w-full rounded-md gap-2 p-2 mt-2 w-full text-sm border border-green-800" required>
               <?php 
               $id  = $_GET['id'];
               if($id === '1'){
