...
<body>
  <div class="mt-20">
    ...
    <img style="width: 200px;" class=" ml-5" src="images/logo.png">
      ...
      <button type="submit" class="rounded-md bg-green-800  text-white w-3/4 p-3 mt-8 mb-8 w-3/4 text-sm"><a href="index.php">Log in</a></button>
      
      </div>
      <div class="w-96 flex justify-center items-center p-6 bg-white m-auto my-5 border border-green-800">
          <span class="text-sm ">Don't have an account?</span><a href="sign up.php" class=" text-green-900 text-sm  font-semibold">Sign up</a>
      </div></div>
